        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowIndividual = table.Column<bool>(type: "bit", nullable: false),
                    AllowTeam = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contests_AspNetUsers_OrganizerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContestImages_Contests_ContestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContestRegistrations_Students_LeaderId",
                        column: x => x.LeaderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContestRegistrationId = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContestMembers_ContestRegistrations_ContestRegistrationId",
                        column: x => x.ContestRegistrationId,
                        principalTable: "ContestRegistrations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContestMembers_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "05fdc196-3c3b-445c-95c5-f0455bcc6e8b", "Quản trị viên hệ thống", "Admin", "ADMIN" },
                    { 2, "5d54d2ed-a486-4418-88e2-9d47a6017e37", "Giảng viên", "Lecturer", "LECTURER" },
                    { 3, "d6059bb3-1e5d-4bb0-b103-8d2936a08d5d", "Sinh viên", "Student", "STUDENT" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContestImages_ContestId",
                table: "ContestImages",
                column: "ContestId");

            migrationBuilder.CreateIndex(
                name: "IX_ContestMembers_ContestRegistrationId_StudentId",
                table: "ContestMembers",
                columns: new[] { "ContestRegistrationId", "StudentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ContestMembers_StudentId",
                table: "ContestMembers",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContestRegistrations_LeaderId",
                table: "ContestRegistrations",
                column: "LeaderId");
